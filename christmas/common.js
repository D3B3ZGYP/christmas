 ...
 * @param {Event} e 
 */
function tableselectorEventListener(e){
    /**
     * @type {HTMLInputElement}
     */
    const target = e.target

    const tableDivs = document.body.querySelectorAll("body > div:has(> table)")

    for (const i of tableDivs){
        if (i.id == target.value)
...
document.getElementById("tableselector").addEventListener("change", tableselectorEventListener)
